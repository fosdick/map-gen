...
def edge():
    ...
    while cnt1 < 100 :
        ...
        if c_fuzz(ckpx,(255,125,0),5):
            ss = find_near(scr1,ckpx,(255,0,0),5,10)
            for i in ss:
        ...
        if c_fuzz(ckpx,(0,144,54),10) or c_fuzz(ckpx,(222,237,203),10):
            ss = set()
        ...
        if c_fuzz(ckpx,(255,255,0),5):
            ss = set()
            ss = (find_near(scr1,ckpx,(255,255,0),5,10))
            if len(ss) > 1150:
                for i in ss:
        ...
        cnt1 = cnt1+1
        #return ckpx
    scr1.save('h:/c_bak/la446/project/landuse/'+'fin_'+s_name)
        
# for i in find_near(scr,(30,12),(255,255,255),4):    
    
        
    

#irrelavent below this line, comment out         
##        if ckpx == (255,125,0):     #generate main roads
##            #ss = look4contig(base, x, y)
##            for i in look4contig(rden, x, y):
##                
##            scr.save('h:/c_bak/la446/project/landuse/'+s_name)
##            print "Roads Generated"
##        ckpx = rden.getpixel((x,y))
##        if ckpx == (255,125,0):     #generate main roads
##            #ss = look4contig(base, x, y)
##            for i in look4contig(rden, x, y):
##                fill_color(scale(i),(255,255,255),scr)
##            scr.save('h:/c_bak/la446/project/landuse/'+s_name)
##            print "Roads Generated"
            
##        if ckpx == (0,255,255):
##                ss = look4contig(base, x, y)
##                fill_color(ss, (255,255,255), scr)
##                scr.save('h:/c_bak/la446/project/landuse/'+s_name)
##        if ckpx == (255,255,0):
##            ss = look4contig(base, x, y)
##            fill_color(ss, (255,255,255), scr)
