...
ebldgs = Image.open('h:/c_bak/la446/project/landuse/__site-e-bldg-g2.tif')
eroads = Image.open('h:/c_bak/la446/project/landuse/__site-e-roads-gen2.tif')
...
rden = Image.open('h:/c_bak/la446/project/landuse/__site-roads-enhance1-gen2.tif')
...
def edge():
    ...
    scr2.save('h:/c_bak/la446/project/landuse/'+'fin_gen2_'+s_name)
